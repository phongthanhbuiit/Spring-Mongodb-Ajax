...
<title>Danh sách Thông Tin Phiếu Xuất</title>
...
<link
	href="<c:url value="/resources/css/main/outputInfo.css" />"
	rel="stylesheet">
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2">DANH SÁCH THÔNG TIN PHIẾU XUẤT</h1>
							...
							<div id = "filldiv" class="col-sm">
								<a href="add" class="btn fill-button btn-user btn-block"> <span
									class="fill-button-hover"> <span
										class="fill-button-text"> THÊM THÔNG TIN PHIẾU XUẤT</span>
								</span>
								</a>
							</div>
							<div class="card-body">
									...
									<table class="table table-bordered" id="cusTable">
										<thead>
											<tr>
												...
												<th data-orderable="false"> QR Code</th>
												<th data-orderable="false">Xoá / Xem</th>
											</tr>
										</thead>
									</table>
								</div>
	...
	<script src="<c:url value="/resources/js/main/outputInfo.js" />"
		type="text/javascript"></script>
