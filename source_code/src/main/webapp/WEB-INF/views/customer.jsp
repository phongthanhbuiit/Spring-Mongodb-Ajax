...
<link
	href="<c:url value="/resources/css/main/customer.css" />"
	rel="stylesheet">
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2">DANH SÁCH KHÁCH HÀNG</h1>
							...
							<div id = "filldiv" class="col-sm">
								<a href="add" class="btn fill-button btn-user btn-block"> <span
									class="fill-button-hover"> <span
										class="fill-button-text"> THÊM KHÁCH HÀNG</span>
								</span>
								</a>
							</div>
							<div class="card-body">
	...
	<script src="<c:url value="/resources/js/main/customer.js" />"
		type="text/javascript"></script>
	<!-- Sweet Alert -->
