...
<link href="<c:url value="/resources/css/sb-admin-2.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/resources/css/main/productEdit.css" />"
	rel="stylesheet" type="text/css">
</head>
...
<body class="bg-customizer">
				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="p-5">
							...
							<form id = "formID" class="product windsora-validation" method="post"
								...
								<a id="editProduct" class="btn btn-product btn-block">
								...
								</a> <a href="home" class="btn btn-facebook btn-product btn-block">
	...
	<script src="<c:url value="/resources/js/main/productEdit.js" />"
		type="text/javascript"></script>
