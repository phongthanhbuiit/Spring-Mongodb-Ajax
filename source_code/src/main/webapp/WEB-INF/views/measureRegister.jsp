...
<link href="<c:url value="/resources/css/sb-admin-2.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/resources/css/main/measureRegister.css" />"
	rel="stylesheet" type="text/css">
</head>
...
<body class="bg-customizer">
					...
					<div class="col-lg-7">
						<div class="p-5">
							<div class="text-center">
								<h1 class="h4 text-gray-900 mb-4">Thêm Đo Lường!</h1>
							</div>
							<form class="measure windsora-validation" method="post" name = "windsora-validation" novalidate>
								<div class="form-group row">
								  ...
								  <a id = "addNewMeasure" class="btn btn-measure btn-block"> Thêm Đo Lường</a>
								<hr>
								<a href="back" class="btn btn-google btn-measure btn-block">
									<i class="fa fa-address-card fa-fw "></i> Quay trở về trang đo lường

								</a> <a href="home"
									class="btn btn-facebook btn-measure btn-block"> <i
	...
	<script src="<c:url value="/resources/js/main/measureRegister.js" />"
		type="text/javascript"></script>
