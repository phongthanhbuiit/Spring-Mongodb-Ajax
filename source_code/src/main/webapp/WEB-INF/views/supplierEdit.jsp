...
<link href="<c:url value="/resources/css/sb-admin-2.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/resources/css/main/supplierEdit.css" />"
	rel="stylesheet" type="text/css">
</head>
...
<body class="bg-customizer">
					...
					<div class="col-lg-7">
						<div class="p-5">
							<div class="text-center">
								<h1 class="h4 text-gray-900 mb-4">Chỉnh Sửa Nhà Cung Cấp!</h1>
							</div>
							<form id = "formID" class="supplier windsora-validation" method="post"
								...
								<a id="editSupplier" class="btn btn-supplier btn-block">
									CẬP NHẬT THÔNG TIN </a>

								<hr>
								<a href="back" class="btn btn-google btn-supplier btn-block">
									<i class="fa fa-address-card fa-fw "></i> Quay trở về nhà cung cấp

								</a> <a href="home" class="btn btn-facebook btn-supplier btn-block">
	...
	<script src="<c:url value="/resources/js/main/supplierEdit.js" />"
		type="text/javascript"></script>
