...
<link href="<c:url value="/resources/css/main/outputInfoDetail.css" />"
	rel="stylesheet">
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2">THÔNG TIN CHI TIẾT PHIẾU XUẤT</h1>
					<!-- DataTales Example -->
					<div id="data-table" class="card shadow mb-4 ">
						<div class="col-sm my-4 filldiv">
							<div class="col-sm-6 mb-3 mb-sm-0">
								<label class=label> Khách Hàng: </label> <input type="text"
									step=0.1 class="form-control form-control-inputInfo"
									id="customer" readonly>
							</div>
						</div>
						<div class="col-sm my-4 filldiv">
							<div class="col-sm-6 mb-3 mb-sm-0">
								<label class=label> Ngày Bán: </label> <input type="text"
									class="form-control form-control-inputInfo" id="date"
									 readonly>
							</div>
						</div>
						<div class="my-4">
							...
							<div class="col-sm-6 mt-3 mb-3 mb-sm-0">
								<label class=label> Tổng toàn bộ số tiền: </label> <input type="text"
									class="form-control form-control-inputInfo" id="sumMomey"
									 readonly>
							</div>
							</div>
						</div>
	...
	<script src="<c:url value="/resources/js/main/outputInfoDetail.js" />"
		type="text/javascript"></script>
