...
<title>Thêm Thông Tin Phiếu Nhập</title>
...
<link href="<c:url value="/resources/css/sb-admin-2.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/resources/css/main/inputInfoRegister.css" />"
	rel="stylesheet" type="text/css">
</head>
...
<body class="bg-customizer">
					...
					<div class="col-lg-7">
						<div class="p-5">
							<div class="text-center">
								<h1 class="h4 text-gray-900 mb-4">Thêm Thông Tin Phiếu Nhập!</h1>
							</div>
							<form class="inputInfo windsora-validation" method="post"
								...
								<a id="addNewInputInfo" class="btn btn-inputInfo btn-block">
									Thêm Thông Tin Phiếu Nhập </a>

								<hr>
								<a href="back" class="btn btn-google btn-inputInfo btn-block">
									<i class="fa fa-address-card fa-fw "></i> Quay trở về trang thông Tin Phiếu Nhập
	...
	<script src="<c:url value="/resources/js/main/inputInfoRegister.js" />"
		type="text/javascript"></script>
