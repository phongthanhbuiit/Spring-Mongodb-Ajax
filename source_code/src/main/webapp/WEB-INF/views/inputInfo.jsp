...
<title>Danh sách Thông Tin Phiếu Nhập</title>
...
<link
	href="<c:url value="/resources/css/main/inputInfo.css" />"
	rel="stylesheet">
...
<body id="page-top">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2">DANH SÁCH THÔNG TIN PHIẾU NHẬP</h1>
							...
							<div id = "filldiv" class="col-sm">
								<a href="add" class="btn fill-button btn-user btn-block"> <span
									class="fill-button-hover"> <span
										class="fill-button-text"> THÊM THÔNG TIN PHIẾU NHẬP</span>
								</span>
								</a>
							</div>
							<div class="card-body">
									...
									<table class="table table-bordered" id="cusTable">
										<thead>
											<tr>
												...
												<th>Số Kí</th>
												<th>Số lượng</th>
												<th>Số tiền nhập (VNĐ)</th>
												<th>Tổng số tiền nhập (VNĐ)</th>
												<th>Số tiền xuất (VNĐ)</th>
												<th>Tổng số tiền xuất (VNĐ)</th>
												<th>Nhà cung cấp</th>
												<th data-orderable="false">Ngày Cập Nhật</th>
	...
	<script src="<c:url value="/resources/js/main/inputInfo.js" />"
		type="text/javascript"></script>
