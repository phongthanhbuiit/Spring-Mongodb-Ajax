...
<link href="<c:url value="/resources/css/sb-admin-2.min.css" />"
	rel="stylesheet">
<link href="<c:url value="/resources/css/main/customerRegister.css" />"
	rel="stylesheet" type="text/css">
</head>
...
<body class="bg-customizer">
				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="p-5">
							...
							<form class="customer windsora-validation" method="post" name = "windsora-validation" novalidate>
								<div class="form-group row">
									<div class="col-sm mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-customer"
								...
								<div class="form-group row">
									...
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text"
											class="form-control form-control-customer" id="phone"
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="email" class="form-control form-control-customer"
								  ...
								  <a id = "addNewCustomer" class="btn btn-customer btn-block"> Thêm khách hàng </a>
								
								<hr>
								<a href="back" class="btn btn-google btn-customer btn-block">
									<i class="fa fa-address-card fa-fw "></i> Quay trở về trang
									khách hàng

								</a> <a href="home"
									class="btn btn-facebook btn-customer btn-block"> <i
	...
	<script src="<c:url value="/resources/js/main/customerRegister.js" />"
		type="text/javascript"></script>
